...
export const description =
  'On this page, we’ll dive into the different job value metric endpoints you can use to manage job value assessments programmatically.'
...
## List job value assessments {{ tag: 'GET', label: '/v1/job-value-assessments' }}
...
<Row>
  <Col>
    ...
    <Properties>
      ...
      <Property name="data.is_draft" type="boolean">
        Is draft status.
      </Property>
      <Property name="data.approval_at" type="datetime">
        Datetime of when the job value metric was approved.
      </Property>
      <Property name="data.approval_by" type="string">
        User identifier who sign approval the job value metric.
      </Property>
      <Property name="data.approval_status" type="string">
        approval status.
      </Property>
  ...
  <Col sticky>
    <CodeGroup title="Request" tag="GET" label="/v1/job-value-assessments">
...
## Create job value metric {{ tag: 'POST', label: '/v1/job-value-assessments' }}
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Request" tag="POST" label="/v1/job-value-assessments">
    ```typescript {{ title: 'axios' }}
...
## Retrieve job value metric {{ tag: 'GET', label: '/v1/job-value-assessments/:id' }}
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Request" tag="GET" label="/v1/job-value-assessments/:id">
    ```typescript {{ title: 'axios' }}
...
## Update job value metric {{ tag: 'PATCH', label: '/v1/job-value-assessments/:id' }}
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Request" tag="PATCH" label="/v1/job-value-assessments/:id">
    ```typescript {{ title: 'axios' }}
...
## Delete job value metric {{ tag: 'DELETE', label: '/v1/job-value-assessments/:id' }}
...
<Row>
  ...
  <Col sticky>
    <CodeGroup title="Request" tag="DELETE" label="/v1/job-value-assessments/:id">
    ```typescript {{ title: 'axios' }}
